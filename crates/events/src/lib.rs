...
pub enum KayaEvent {
    ...
    DirectListenerStarted {
        addr: String,
    },
    DirectListenerStopped {
        addr: Option<String>,
    },
    DirectPeerConnected {
        node_id: String,
...
impl KayaEvent {
    pub fn kind(&self) -> EventKind {
        match self {
            ...
            KayaEvent::DirectListenerStarted { .. } => EventKind::DirectListenerStarted,
            KayaEvent::DirectListenerStopped { .. } => EventKind::DirectListenerStopped,
            KayaEvent::DirectPeerConnected { .. } => EventKind::DirectPeerConnected,
            KayaEvent::DirectPeerDisconnected { .. } => EventKind::DirectPeerDisconnected,
            KayaEvent::DirectConnectFailed { .. } => EventKind::DirectConnectFailed,
            KayaEvent::DirectPacketReceived { .. } => EventKind::DirectPacketReceived,
            KayaEvent::DirectPacketSent { .. } => EventKind::DirectPacketSent,
            ...
            KayaEvent::VoiceJoined { .. } => EventKind::VoiceJoined,
            KayaEvent::VoiceLeft { .. } => EventKind::VoiceLeft,
...
impl EventKind {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            EventKind::DirectListenerStarted => "direct.listener.started",
            EventKind::DirectListenerStopped => "direct.listener.stopped",
            EventKind::DirectPeerConnected => "direct.peer.connected",
            EventKind::DirectPeerDisconnected => "direct.peer.disconnected",
            EventKind::DirectConnectFailed => "direct.connect.failed",
            EventKind::DirectPacketReceived => "direct.packet.received",
            EventKind::DirectPacketSent => "direct.packet.sent",
            ...
            EventKind::VoiceJoined => "voice.joined",
            EventKind::VoiceLeft => "voice.left",
